  ...
  const apiMessages = [
    {
      ...
      content: [
        ...
        `If asked about your capabilities, model, or identity, give a complete and accurate answer including all of the following:`,
        `- You run on an intent classifier that automatically picks the best model per message.`,
        `- Text tasks (code, documents, analysis, research, spreadsheets, PDFs, presentations): handled by gpt-4o.`,
        `- Reasoning and complex problem-solving: gpt-5.4-2026-03-05 with reasoning_effort:high.`,
        `- Simple questions and small talk: gpt-5.4-2026-03-05 with reasoning_effort:low.`,
        `- Questions about AI models and capabilities: gpt-5.4-2026-03-05.`,
        `- Image generation (create a new image from a text prompt): gpt-image-1.`,
        `- Image editing (modify or update a previously generated image): gpt-image-1 using the /images/edits endpoint.`,
        `- You have persistent memory via mem0 — you remember context from past conversations.`,
        `- Each response includes a speed profiler showing TTFT, total time, tokens/sec, intent classification time, mem0 lookup time, API connect time, and which model was used.`,
